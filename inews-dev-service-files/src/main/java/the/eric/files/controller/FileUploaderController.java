package the.eric.files.controller;

import the.eric.api.controller.files.FileUploaderControllerApi;
import the.eric.exception.GraceException;
import the.eric.files.resource.FileResource;
import the.eric.files.service.UploaderService;
...
import the.eric.utils.FileUtils;
import the.eric.utils.extend.AliImageReviewUtils;
...
//                    finalPath = fileResource.getHost() + path;
    ...
    public static final String FAILED_IMAGE_URL = "https://inews-dev.oss-cn-beijing.aliyuncs.com/image/faild.jpeg";
